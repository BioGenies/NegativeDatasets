...
tar_load(c(positive_traintest, methods, dataset_colors, aa_comp_peptides_with_names, aa_comp_peptides, aa_comp_peptides_positive,
           aa_comp_peptides_all, aa_comp, aa_comp_pos, aa_comp_all, df_neg, df_pos, df_all))
```
...
aa_comp_peptides_heatmap_dat <- bind_rows(aa_comp_peptides_with_names, aa_comp_peptides_pos) %>% 
